package com.demo.bootplus.util;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/mydata?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.demo.bootplus");
        pc.setEntity("model");
        pc.setMapper("mapper");
